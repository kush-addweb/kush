...
<main>
    ...
    <div class="contact-area pt-100 pb-100">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <form id="contacts-form" method="post" class="contacts-form" action="../controller/comments.php">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="contacts-icon contactss-email">
                                    <input type="email" name="e-mail" placeholder="Your Email Address" required>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12">
                                <div class="contacts-icon contactss-website">
                                    <input type="text" name="ph-num" placeholder="Your Phone" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="contacts-icon contactss-message">
                                    <textarea name="comments" name="comments" id="comments" cols="30" rows="10" placeholder="Your Comments...."></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="contacts-form-button text-center">
                                    <button type="submit" class="c-btn" name="submit">
